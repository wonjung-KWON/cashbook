                            ...
                            <div class="table-responsive">
								...
								<table class="table table-bordered">
									...
									<tr>
										<td>패스워드</td>
										<td>
											<div id="byElement">******** <button id="toggleButton" type="button" class="btn btn-dark">비밀번호 변경</button></div>
											<div id="myElement">
											<form action="${pageContext.request.contextPath}/on/modifyMember" method="post" id="pwForm">
												<span>현재 비밀번호 :</span>
												<input type="password" name="checkPw"  required="required"><br><br>
												
												<span>변경할 비밀번호 :</span>
												<input type="password" name="memberPw"  required="required"><br><br>
							
												<span>변경할 비밀번호 확인 :</span>
												<input type="password" name="ckPw" required="required"><br><br>
												
												<button class="btn btn-dark" type="button" id="toggle2Button">취소</button>
