                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" id="addMemberForm" method="post" action="${pageContext.request.contextPath}/off/addMember">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="tel" class="form-control form-control-user" id="addPhone"
                                            placeholder="전화번호">
                                         <span id="addPhoneMsg"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="addId"
                                        placeholder="아이디">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="addPw" placeholder="비밀번호">
                                        <span id="addPwMsg"></span>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="addPwCk" placeholder="비밀번호 재입력">
                                            <span id="addPwCkMsg"></span>
                                    </div>
                                </div>
                                <button class="btn btn-primary btn-user btn-block" id="addMemberBtn" type="button">회원가입</button>
                                <hr>
                                <a href="${pageContext.request.contextPath}/off/login" class="btn btn-google btn-user btn-block">
                                     로그인 하기
                                </a>
                                <a href="${pageContext.request.contextPath}/on/home" class="btn btn-facebook btn-user btn-block">
                                    HOME
                                </a>
                            </form>
                            <hr>
